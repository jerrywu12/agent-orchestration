...
- `BulkPlanningTransition({tickets,state,integrations,onClose,onComplete})`; onComplete receives admitted IDs including launch-failed admissions, once; refresh failure separate.
