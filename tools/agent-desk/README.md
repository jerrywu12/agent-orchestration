...
Limits are five combined documents per ticket, 10 MiB per file, 1,000,000 Markdown characters
and 500,000 extracted characters per other file,
...
20-second deadline and 256 MiB V8 heap limit per worker (not a total process-memory limit).
